...
/**
 * Class SMBCriticalPercent
 */
class SMBCriticalPercent implements ObjectConfigInterface
{
    /** @var int */
    private $percent;
    ...
    public function __construct(int $percent)
    {
        if ($percent < 0 || $percent > 100) {
            throw new InvalidArgumentException(__('SMB critical percent must be between 0 and 100'));
        }
